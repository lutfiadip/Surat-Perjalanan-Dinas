    ...
    <table style="width: 100%; border: none;">
        <tr>
            <td style="padding-left: 30px;">
                <div class="center" style="font-size: 12pt; margin-bottom: 5px; margin-top: 10px; font-weight: bold;">
                    SURAT
                    TUGAS</div>
                <table style="width: 100%; border: none; margin-bottom: 20px;">
                    <tr>
                        <td style="width: 35%; text-align: right; border: none; padding-right: 5px; font-weight: bold;">
                            Nomor :
                        </td>
                        <td style="width: 60%; text-align: left; border: none; padding-left: 5px; font-weight: bold;">
                            {{ $data['nomor_surat'] }}
                        </td>
                    </tr>
                </table>
                            ...
                            @foreach($selectedPegawais as $index => $pegawai)
                                <table
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 0;">
                                            <table style="margin: 0; padding: 0; border-collapse: collapse;" cellpadding="0"
                                                cellspacing="0">
                                                <tr>
    ...
    <table id="page3table" class="border" style="font-size: 10pt; width: 100%; table-layout: fixed;">
        ...
        <tr>
            ...
            <td class="border" style="padding: 2px 2px 2px 5px; vertical-align: top; width: 58%;">
                <table style="width: 100%; border: none; font-size: 10pt; border-collapse: collapse;" cellspacing="0"
                    cellpadding="0">
                    <tr>
                        <td
                    ...
                    <tr>
                        <td></td>
                        <td style="padding: 0px 0px 0px 10px; mso-padding-alt: 0pt 0pt 0pt 10pt; vertical-align: top;">
                            Ke</td>
                        <td>:</td>
                        <td>{!! nl2br(e($data['tempat'])) !!}</td>
                    </tr>
