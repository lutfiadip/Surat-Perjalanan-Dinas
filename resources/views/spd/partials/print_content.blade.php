...
<div class="page" style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <div style="padding-left: 30px;">
        ...
        <table class="spd-table" style="table-layout: fixed; width: 100%;">
            ...
            <tr>
                <td style="text-align: center; vertical-align: top; border: 1px solid black; padding: 5px; width: 5%;">
                    1
                </td>
            ...
            <!-- Row 3a: Pangkat -->
            <tr>
                <td rowspan="3" style="text-align: center; vertical-align: top; border: 1px solid black; padding: 5px;">
                    3</td>
                <td
