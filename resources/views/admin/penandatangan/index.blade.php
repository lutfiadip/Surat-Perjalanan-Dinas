...
<body class="bg-[#FFF8F3] font-['Instrument_Sans'] antialiased selection:bg-[#1C6DD0] selection:text-white">
    <div class="relative min-h-screen overflow-hidden flex flex-col">
        ...
        <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div
                class="fixed top-24 left-1/2 transform -translate-x-1/2 z-[100] w-full max-w-lg px-4 pointer-events-none flex flex-col gap-2">
                @if(session('success'))
                    <div class="flash-message mb-4 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl flex items-center justify-between gap-2 shadow-lg transition-all duration-500 pointer-events-auto"
                        role="alert">
                        ...
                        <button onclick="this.closest('.flash-message').style.display='none'"
                ...
                @if(session('error'))
                    <div class="flash-message mb-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-center justify-between gap-2 shadow-lg transition-all duration-500 pointer-events-auto"
                        role="alert">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-medium text-sm leading-snug">{!! nl2br(e(session('error'))) !!}</span>
                        </div>
                        <button onclick="this.closest('.flash-message').style.display='none'"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-slate-50/50 border-b border-slate-100">
                                ...
                                <th
                                    class="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider w-32">
                                    Jenis</th>
                                <th
                                    class="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider w-32">
                                    Varian</th>
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-4 text-sm text-slate-500">
                        <span>
                            Showing
                            <span class="font-medium text-slate-900">{{ $penandatangan->firstItem() }}</span>
                            to
                            <span class="font-medium text-slate-900">{{ $penandatangan->lastItem() }}</span>
                            of
                            <span class="font-medium text-slate-900">{{ $penandatangan->total() }}</span>
                            results
                        </span>
                    ...
                    <div class="w-full md:w-auto">
                        {{ $penandatangan->appends(['per_page' => request('per_page')])->links('vendor.pagination.admin-links') }}
                    </div>
                </div>
            </div>
        </main>
